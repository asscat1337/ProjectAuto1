...
$sql = mysqli_query($link,"INSERT into `arhive`(`archive_id`,`fio`,`date`,`telephone`,`filename`,`path`,`status`,`checked`) 
VALUES (NULL,'$fio','$date','$tel','$filename','$path','$status',0)");
var_dump("INSERT into `archive`(`archive_id`,`fio`,`data`,`telephone`,`filename`,`path`,`status`,`checked`) 
VALUES (NULL,'$fio','$date','$tel','$filename','$path','$status',0)");
